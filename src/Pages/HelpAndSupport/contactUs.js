    ...
    <View style={styles.container}>
      ...
      <View style={styles.selectIssue}>
        <View style={{ width: "100%" }}>
          ...
          <Text style={{ color: "#AAAAAA", fontSize: 12, fontWeight: "500" }}>
            Select what types of issue are you facing
          </Text>
        </View>
      ...
      <View style={styles.detailIssue}>
        <View style={{ width: "100%" }}>
          ...
          <Text style={{ color: "#AAAAAA", fontSize: 12, fontWeight: "500" }}>
            Write us something about your issues
          </Text>
        </View>
